...
async def run():
    async with async_playwright() as p:
        ...
        # Sumatra Ovale 500x300x120
        url = "https://www.grepool.com/it/piscine-in-acciaio/sumatra-ovale/500-x-300-x-120-cm-4"
        ...
        try:
            ...
            await page.wait_for_selector("a[href*='netrivals.com']", timeout=10000)
